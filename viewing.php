...
<title>Nilai Bahasa Inggris</title>
...
<div id="nav"> <a href="home.php">Home</a> <a href="prestasi.php">Prestasi</a><a href="profil.php">Kegiatan Baru</a> <a href="raporsiswa.php">Raport</a><span class="more"><a href="visidanmisi.php">Visi $ Misi</a> <a href="logout.php">Log out</a></span>  </div>
  <div id="body">
    <div id="body-top">
      <div id="body-bot">
        <div class="clear">
...
<table width="400" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" celpading="2" celspacing="1" > 
  <tr bgcolor="#CCFFFF"> 
    ...
    <td><div align="center"><strong>Nilai Bhs Inggris</strong></div></td>   
 ...
 $query = mysql_query("select * from nilaiing");
