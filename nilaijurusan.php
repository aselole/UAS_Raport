...
<table width="400" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" celpading="2" celspacing="1" > 
  <tr bgcolor="#CCFFFF"> 
    ...
    <td><div align="center"><strong>Nilai Jurusan</strong></div></td>   
 ...
 $query = mysql_query("select * from nilaijurusan");
 ...
 <td><?php echo $r['nilai_jurusan'] ?></td>
 <td><a href="editjurusan.php?&edit=<?php echo $r['id'] ?>">Input Nilai</a> 
</td>
  </tr> 
    <?php } ?> 
</table>
